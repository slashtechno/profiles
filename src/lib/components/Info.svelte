...
<Dialog.Root>
  ...
  <!-- On small screens (smaller than sm), the dialog will take up the full width of the screen. On larger screens, it will be capped at 600px. -->
  <Dialog.Content class="sm:max-w-[600px] max-h-[85vh] overflow-y-auto scroll">
    <Dialog.Header>
    ...
    <div class="flex justify-center flex-col items-center">
      ...
      <br>
      <p>The code is open source and contributions are welcome!</p>
    </div>
    <Button href="https://github.com/slashtechno/profiles" target="_blank">
      View on GitHub (and maybe star it?)
    </Button>
    <Dialog.Footer>
